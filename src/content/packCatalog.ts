...
export const BUNDLED_PACK_CATALOG: PackCatalog = {
  ...
  packs: [
    ...
    },
    {
      ...
      summary:
        "Fast fixes for when things break and the store is closed: leaking lines and radiators, a snapped belt, a flat with no jack, no pump, no light, no coat; calling for help on a radio and rigging an antenna; the chainsaw, felling, and bucking rules. From the Army repair, rigging, radio, and survival manuals, OSHA, and the Forest Service where they exist, and marked \"not yet sourced\" where a trick is only hand-me-down.",
      version: 1,
      bytes: 47000,
      articleCount: 18,
      license: "Original text written for GuideHand. Sources named on every article: U.S. Army field manuals (FM 4-30.31, FM 5-125, FM 6-02.53, ATP 3-50.21), the Forest Service saw and tree-climbing guides, OSHA, the FCC rules, NOAA, the Coast Guard, and MedlinePlus. Lines that come only from hand-me-down field practice say so.",
      attribution: "U.S. Army field manuals; USDA Forest Service; OSHA; FCC rules (47 CFR); NOAA; U.S. Coast Guard; MedlinePlus",
      icon: "tools",
