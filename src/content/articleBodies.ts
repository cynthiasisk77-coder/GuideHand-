...
export const ARTICLE_BODIES: Record<string, ArticleBody> = {
  ...
  "Making water safe to drink": {
    sources: ["CDC, \"Making Water Safe in an Emergency\"","U.S. EPA, Emergency Disinfection of Drinking Water"],
    guidance: [
      "Start by making it clear. If the water is cloudy, murky or has bits in it, let it settle and pour off the clear water, or strain it through a clean cloth or coffee filter first. Every method below works better on clear water, and two of them barely work at all on dirty water.",
      "Boiling is the most reliable thing you can do and it needs no supplies. Bring it to a rolling boil \u2014 bubbling hard, not just steaming \u2014 and hold it there for one full minute. Above about 6,500 feet of elevation, make it three minutes, because water boils cooler up high. Let it cool on its own; do not add ice or cold water to speed it up.",
      "Boiled water tastes flat because the air has been driven out of it. Pour it back and forth between two clean containers a few times and the taste comes back.",
      "If you cannot boil, use unscented household bleach \u2014 plain chlorine bleach, nothing scented, no added cleaners, no colour-safe. Check the label says 5 to 9 percent sodium hypochlorite.",
      "The amounts: for clear water, 8 drops of 5-to-9-percent bleach per gallon, which is about an eighth of a teaspoon. Two drops per quart. For cloudy water you could not clear, double it \u2014 16 drops per gallon. Stir it, and leave it 30 minutes before drinking.",
      "After 30 minutes it should smell faintly of chlorine, like a swimming pool. If it does not, repeat the dose and wait another 15 minutes. If it still has no smell after that, find another source \u2014 something in the water is using up the chlorine faster than you can add it.",
      "Bleach loses strength sitting on a shelf, faster in heat. A bottle more than a year old may not do the job, so date it when you buy it and replace it.",
      "A filter works if it is the right kind. You want one rated 0.1 to 0.3 micron absolute \u2014 that catches bacteria and parasites like giardia and cryptosporidium, which chlorine is poor against. Most backpacking filters do not stop viruses, so in a situation where sewage may be in the water, filter first and then add bleach or boil.",
      "What none of this fixes: fuel, solvents, pesticides, industrial chemicals, or radioactive contamination. Boiling actually concentrates those rather than removing them. If the water smells of fuel or chemicals, or you have been told there is chemical or radiological contamination, do not treat it \u2014 use a different source.",
      "Never drink from a heating radiator, a boiler, a waterbed, or a swimming pool or hot tub. Pool water carries chemicals at levels meant for skin, not for drinking.",
      "Store what you have treated in clean containers with lids, and keep the outside of the container clean too \u2014 recontaminating good water with a dirty lip or dirty hands is the commonest way people get sick after doing everything else right.",
    ],
  },
  "Planting a basic vegetable garden": {
    sources: ["USDA home gardening guidance","State Cooperative Extension Service master gardener programmes"],
    guidance: [
      "Grow what you will actually eat, and start smaller than you want to. A 4 by 8 foot bed that gets tended beats a quarter acre that gets abandoned in July. You can always add a bed next year.",
      "Sun decides more than anything else. Anything you eat the fruit of \u2014 tomatoes, beans, squash, peppers \u2014 wants six to eight hours of direct sun. Leafy things like lettuce, spinach, chard and kale will take four to six and are the answer for a shadier yard. Watch where the sun actually falls across a day before you dig.",
      "Loosen the soil eight to twelve inches down and work in two or three inches of compost or well-rotted manure. That single step does more for a first garden than any fertiliser. If your ground is solid clay or rock, build a raised bed on top of it instead of fighting it.",
      "The easiest high-return crops for a beginner: radishes (ready in about a month), leaf lettuce (cut it and it grows back), bush beans (no trellis needed), summer squash, chard and kale. Those will feed you while you learn.",
      "How deep to plant a seed: about two to three times as deep as the seed is wide. Tiny seeds like lettuce and carrots go barely under the surface. Beans and squash go an inch or so down. Planting too deep is the most common reason nothing comes up.",
      "Thin the seedlings even though it feels wrong. Two carrots crowded together make two bad carrots. Snip the extras off at soil level with scissors rather than pulling, so you do not disturb the roots of the one you keep.",
      "Water deeply and less often rather than a little every day. A long soak twice a week drives roots down where the soil stays damp; a daily sprinkle keeps them shallow and the plant suffers the first hot week. Water the soil, not the leaves, and do it in the morning \u2014 wet leaves overnight invite disease.",
      "Mulch two or three inches of straw, leaves or grass clippings around everything once plants are up. It holds water in, keeps weeds down, and keeps soil from splashing onto leaves.",
      "Do not plant everything at once. Sow a short row of lettuce, beans or radishes every two weeks instead. Otherwise you get forty heads of lettuce in one week and none for the rest of the season.",
      "Know your last spring frost and first autumn frost dates for where you live \u2014 your local Extension office publishes them. Peas, lettuce and spinach go in weeks before the last frost. Tomatoes, beans, squash and peppers go in after it, in warm soil. The calendar month matters far less than those two dates.",
      "No ground at all still works. A five-gallon bucket with holes drilled in the bottom grows one tomato plant, one squash, or a good crop of lettuce. Containers dry out much faster, so expect to water most days in summer.",
      "Save seed from open-pollinated or heirloom varieties if you want next year's garden to come from this one. Seed saved from hybrids \u2014 usually marked F1 \u2014 will grow, but it will not come back true to the plant you liked.",
    ],
  },
  "Canning basics: jars, lids and the two methods": {
    sources: ["National Center for Home Food Preservation / USDA Complete Guide to Home Canning","CDC, \"Home-Canned Foods\""],
    guidance: [
      "There are two methods and the food decides which one, not you. How acidic it is determines whether botulism spores can survive, and botulism from home canning is rare precisely because people follow that rule.",
      "Water-bath canning is for high-acid food: most fruit, jam, jelly, pickles, and anything you have deliberately acidified. Jars sit covered by boiling water for a set time.",
      "Pressure canning is the only safe method for low-acid food: all vegetables, meat, poultry, fish, beans, and soups. A pot of boiling water never gets hot enough to kill botulism spores in low-acid food no matter how long you leave it. This is the one rule with no exceptions and no workaround.",
      "Tomatoes sit on the line and modern varieties are often not acidic enough on their own. Tested recipes add a measured amount of bottled lemon juice or citric acid \u2014 bottled, because fresh lemons vary in strength. Add it.",
      "What you need: canning jars, new flat lids every single time, screw bands which can be reused until they rust or bend, a canner of the right type, and a jar lifter. Old mayonnaise jars are not canning jars and will break.",
      "Leave headspace \u2014 the gap between the food and the rim. The recipe tells you how much, usually a quarter inch for jams and an inch for vegetables and meat. Too little and it boils out and ruins the seal; too much and the air left behind stops a proper vacuum forming.",
      "Wipe every rim with a clean damp cloth before the lid goes on. A smear of jam on the rim is the commonest cause of a seal that fails a week later.",
      "Screw the band on fingertip tight, not hard. Air has to escape during processing, and a band cranked down traps it and buckles the lid.",
      "Process for the full time the tested recipe gives, and adjust for your altitude \u2014 both methods need longer or higher pressure the higher up you are. Start timing only once the water is at a full boil or the canner has reached pressure.",
      "Let the jars sit undisturbed on a towel for 12 to 24 hours afterwards. You will hear them ping as they seal. Do not press the lids while they cool and do not tighten the bands.",
      "Then check each seal: the lid should be slightly concave and should not flex at all when pressed in the middle. Anything that did not seal goes in the fridge to eat within a few days, or gets reprocessed with a new lid.",
      "Take the bands off before storing. It sounds backwards, but a band can hold a failed lid in place and hide the fact that the seal broke. Without it, a bad jar shows itself.",
      "Label every jar with what it is and the date, and store somewhere cool and dark. Use within a year for best quality.",
      "Throw out, without tasting, any jar that is bulging, leaking, spurting when opened, mouldy, foul-smelling, or that has a lid which has come unsealed. Botulism toxin has no taste or smell, so a taste test proves nothing and risks everything.",
    ],
  },
  ...
  "Headache: easing it, and the signs it is an emergency": {
    sources: [
      "MedlinePlus (U.S. National Library of Medicine), \"Headache\"",
      "MedlinePlus (U.S. National Library of Medicine), \"Migraine\"",
      "NHS, \"Headaches\"",
      "NHS, \"Aspirin: medicine for pain relief or preventing blood clots\"",
    ],
    guidance: [
      "Most headaches are not serious and go away on their own. The common one is a tension headache: a dull, squeezing pain like a tight band, usually on both sides, often starting at the back of the head, with tight shoulders, neck, or jaw. Stress, holding your head in an awkward position, eye strain, missed meals, too little water, and a cold or the flu all bring them on. A migraine is different: throbbing or pounding, usually on one side, worse when you move, often with nausea and sensitivity to light and sound, and sometimes with warning signs (an aura, often in your vision) before the pain starts.",
      "Before anything else, think about where you are. A headache with dizziness, weakness, nausea, or confusion, especially when more than one person in the house gets it around the same time or a generator, stove, or heater is running indoors, is carbon monoxide until proven otherwise. Everyone out into fresh air now, then see Smoke inhalation and carbon monoxide.",
      "To ease an ordinary headache: drink water (dehydration is a common cause, more so if you have vomited), rest somewhere quiet and dark, put a cool cloth on your head, and try to relax, because stress makes it worse. Don't skip meals even if you don't feel like eating, don't sleep more than you usually would (it can make the headache worse), rest your eyes from screens, and leave alcohol alone.",
      "For a tension headache, acetaminophen (Tylenol), ibuprofen, or aspirin, taken exactly as the label says, usually helps. Two limits. Never give aspirin to a child aged 15 or under: it can cause a rare but serious condition called Reye's syndrome. And after any head injury, use acetaminophen only for the first 48 hours (see Head, neck and spinal injury).",
      "Watch how often you reach for pain medicine. Taking it 3 or more days a week, week after week, causes rebound headaches: headaches that keep coming back because of the medicine itself. Too much acetaminophen can damage the liver; too much ibuprofen, naproxen, or aspirin can irritate the stomach or damage the kidneys. In a long emergency, with short sleep and high stress, this is an easy trap to fall into.",
      "If you get migraines, treat it at the first sign: fluids, a dark quiet room, and your usual medicine if a provider has prescribed one, taken as instructed. Over-the-counter pain relievers often help while a migraine is still mild. Common triggers are missed sleep, missed meals, alcohol, certain foods (chocolate, some cheeses, MSG), and caffeine withdrawal, which is worth knowing when the coffee runs out.",
      "A headache diary finds the pattern: the day and time it began, what you ate and drank over the past 24 hours, how much you slept, what you were doing and where you were just before it started, how long it lasted, and what made it stop. If you get the chance to see a provider later, that record is the most useful thing you can bring.",
      "Get medical help right away, by whatever route actually works (call if you have signal; otherwise get them there, or send someone), for any of these: a headache that comes on suddenly and is explosive, violent, or \"the worst ever\", even in someone who gets headaches often, because it can mean a burst blood vessel in the brain; a headache with slurred speech, a change or loss of vision, weakness or numbness in the face or body, trouble walking or keeping balance, confusion, memory loss, or drowsiness; a headache with a seizure; a headache with a fever, a stiff neck, nausea and vomiting, or bright lights hurting the eyes, or with a rash that does not fade when a glass is rolled over it; any headache after a head injury, and a fall or blow within the last 3 months counts; severe pain in just one eye, with that eye red.",
      "Get seen soon, even if it is not tonight, for: the first bad headache of your life if it stops you doing normal things; a headache that keeps getting worse over 24 hours, or comes back day after day; headaches that start for the first time after age 50; a headache with vision problems, pain while chewing, or a sore or tender scalp; a headache brought on or made worse by coughing, sneezing, bending down, or exercise; a child whose headache is getting worse or wakes them at night; a new headache in someone with cancer or a weakened immune system; or one that home care simply isn't touching.",
      "If someone with a bad headache needs to get to care, do not let them drive themselves. Have someone take them, and bring the medicines they take.",
      "Pregnant: a severe, persistent headache, especially with sudden swelling of the face or hands or changes in vision, is one of the warning signs of preeclampsia. See Pregnancy considerations across scenarios.",
    ],
  },
